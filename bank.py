...
class Bank(ABC):
    ...
    """
    def basicinfo(self):
        """prints out "This is a generic bank" and returns the string
        "Generic Bank: 0" """
    ...
    @abstractmethod
    def withdraw(self):
        """ Astract method for withdrawing money"""
        pass
...
class Swiss(Bank):
    ...
    def basicinfo(self):
        """ Prints "this is the Swiss Bank" and returns a string with "Swiss Bank: {self.bal}" """
